...
db "FDC Microsol "      ;comment

fdcjmp  dw fdcinp,fdcout,fdcact,fdcmof0
fdcmof  jp fdcmofx
        db 32*0+4       ;bit[0-4]=driver ID (4=microsol), bit[5-7]=storage type (0=FDC)
        ds 4
fdcslt  ds 3
...
;### Destroyed  AF,DE
fdcexe  out (fdc_sector),a      ;Sector setzen
        ld a,(stobnkx)
        call bnkmonx
        ld (fdcmon4+1),a
        ld a,b
